...
const SERVICES = [
  ...
  { emoji: "✨", name: "Set Híbrido", originalPrice: "$149.99", salePrice: "$134.99", isFavorite: false, isFlat: false, imageSrc: imgHybrid, imagePosition: "center 58%", description: "Natural con más volumen. El favorito de nuestras clientas.", highlightBorder: true, badgeText: "Incluye 10% desc.", badgeType: "discount" as const },
